...
def test_add_scalars(scalar1, scalar2, expected_result, adder, factory):
    s1 = factory.make_scalar(scalar1)
    s2 = factory.make_scalar(scalar2)
...
def test_add_scalar_with_number(
    scalar, number, expected_result, adder, factory
):
    s = factory.make_scalar(scalar)
...
def test_add_vectors(vector1, vector2, expected_result, adder, factory):
    v1 = factory.make_vector(vector1)
    v2 = factory.make_vector(vector2)
...
def test_add_bivectors(bivector1, bivector2, expected_result, adder, factory):
    bv1 = factory.make_bivector(bivector1)
    bv2 = factory.make_bivector(bivector2)
...
def test_add_elements(element1, element2, expected_result, adder, factory):
    e1 = factory.make_element(
        factory.make_scalar(element1[0]),
        factory.make_vector(element1[1], element1[2]),
        factory.make_bivector(element1[3])
    )
    e2 = factory.make_element(
        factory.make_scalar(element2[0]),
        factory.make_vector(element2[1], element2[2]),
        factory.make_bivector(element2[3])
    )
...
def test_add_scalar_with_vector(scalar, vector, adder, factory):
    s = factory.make_scalar(scalar)
    v = factory.make_vector(vector)
...
def test_add_scalar_with_bivector(scalar, bivector, adder, factory):
    s = factory.make_scalar(scalar)
    bv = factory.make_bivector(bivector)
...
def test_add_element_with_scalar(
    element, scalar, expected_scalar_result, adder, factory
):
    e = factory.make_element(
        factory.make_scalar(element[0]),
        factory.make_vector(element[1], element[2]),
        factory.make_bivector(element[3])
    )
    s = factory.make_scalar(scalar)
...
def test_add_vector_with_bivector(vector, bivector, adder, factory):
    v = factory.make_vector(vector)
    bv = factory.make_bivector(bivector)
...
def test_add_element_with_vector(
    element, vector, expected_vector_result, adder, factory
):
    e = factory.make_element(
        factory.make_scalar(element[0]),
        factory.make_vector(element[1], element[2]),
...
def test_add_element_with_bivector(
    element, bivector, expected_bivector_result, adder, factory
):
    e = factory.make_element(
        factory.make_scalar(element[0]),
        factory.make_vector(element[1], element[2]),
...
def test_order_of_elements_doesnt_matter(adder, factory):
    s1 = factory.make_scalar(4.3)
    s2 = factory.make_scalar(-3.3)
    v1 = factory.make_vector(14.8, 14.5)
    v2 = factory.make_vector(10.6, -4.5)
    bv1 = factory.make_bivector(4.8)
    bv2 = factory.make_bivector(-1.6)
    e1 = factory.make_element(s1, v1)
    e2 = factory.make_element(s2, v2)
